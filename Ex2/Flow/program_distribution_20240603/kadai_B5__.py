...
def calcoutparam(A_DATA, xgridsize, ygridsize):
    ...
    return wid_num, heinum


def summarize(xgridsize, ygridsize, int_window, see_window, wid_num, heinum,
    ...
    line = ["#", wid_num, heinum, wid_num * heinum, xgridsize, ygridsize, xposition[0], yposition[0]]
    csvform.append(line)
...
def writematrix(outfilename, xgridsize, ygridsize,
                int_window, see_window, wid_num, heinum,
                xposition, yposition, xdisplacement, ydisplacement):

    csvform = []
    summarize(xgridsize, ygridsize, int_window, see_window, wid_num, heinum,
              xposition, yposition, xdisplacement, ydisplacement, csvform)
